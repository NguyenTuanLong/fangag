...
from posts.views import PostCreateView,index,category,deletePost, updatePost,random_post, post, like, dislike, like_comment, dislike_comment, report
from users.views import register, profile

urlpatterns = [
    path('admin/', admin.site.urls),
    # path('admin/reports/<str:post_id>', reportedPost),
    ...
    path('gag/<str:post_id>/report/', report, name='report'),
